...
class Issue(models.Model):
    ...
    status = models.ForeignKey(verbose_name='Status', to='webapp.Status', null=False, blank=False, related_name='issue', on_delete=models.RESTRICT)
    type = models.ForeignKey(verbose_name='Type', to='webapp.Type', null=False, blank=False, related_name='issue', on_delete=models.RESTRICT)
